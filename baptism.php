...
<div class="container">
	<div class="ui attached secondary pointing stackable sticky mobile tablet menu" id="menu">
		...
		<div class="ui dropdown item services" >
			...
			<div class="menu">
				<a href="baptism.php?page=1" class="active item">Baptism Schedule</a>
		...
		<div class="ui grid">
			...
			<div class="fourteen wide column">
				<h1 class="ui grey dividing header">
					...
					<div class="content">
			           	BAPTISM SCHEDULES
		              <div class="sub header">List of baptism schedules</div>
	            	</div>
				...
				<?php displaySched("Baptism"); ?>
			</div>
			<div class="column"></div>
			<div class="row">
				<div class="two wide column"></div>
				<?php pages("baptism.php","schedule","Baptism"); ?>
				<div class="two wide column"></div>
			</div>
		</div>
		<div class="ui grid">
