		...
		<div class="ui grid">
			...
			<div class="fourteen wide column">
				<h1 class="ui grey dividing header">
					...
					<div class="content">
			           	MASS SCHEDULES
		              <div class="sub header">List of mass schedules</div>
	            	</div>
				...
				<?php displayMassSched(); ?>
			</div>
			<div class="column"></div>
			<div class="row">
				<div class="column"></div>
				<?php pages("mass.php","schedule","Mass"); ?>
				<div class="two wide column"></div>
			</div>
		</div>
		<div class="ui grid">
...
function open_search(){
	...
	var myURL = "massresult.php?page=1&option1="+ option1+"&option2="+option2+"&option3="+option3+"&option4="+option4;
